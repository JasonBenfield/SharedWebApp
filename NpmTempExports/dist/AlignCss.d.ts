...
export declare class AlignCssType implements ICssBuilder {
...
export declare class AlignContentCssType implements ICssBuilder {
    private readonly breakpoints;
    constructor();
...
export declare class AlignCss implements ICssBuilder {
