...
describe('Formatted Date', function () {
    it('Default formatting', function () {
        ...
        chai_1.expect(formattedDate.formatDate()).to.equal('1/17/21');
        chai_1.expect(formattedDate.formatTime()).to.equal('8:05 AM');
        chai_1.expect(formattedDate.formatDateTime()).to.equal('1/17/21 8:05 AM');
    });
    it('Default formatting for Date only', function () {
        ...
        chai_1.expect(formattedDate.formatDateTime()).to.equal('1/17/21');
    });
});
