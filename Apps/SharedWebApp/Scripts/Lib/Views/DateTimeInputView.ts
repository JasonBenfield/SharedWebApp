...
export class DateTimeInputView extends InputGroupView {
    readonly dateInpuView: InputView;
    ...
    constructor(container: BasicComponentView) {
        super(container);
        this.dateInpuView = this.appendFormControl(InputView);
    ...
    styleAsFormControl() {
        this.dateInpuView.styleAsFormControl();
    ...
    includeSeconds() {
        this.setMaxWidth(CssLengthUnit.em(60));
    }

    excludeSeconds() {
        this.setMaxWidth(CssLengthUnit.em(40));
    }
